function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        if(navigator.userAgent.indexOf("Opera")>0 || navigator.userAgent.indexOf("OPR")>0){
			...
			createjs.Sound.registerSound("./sounds/choose_bonus_item.ogg", "choose_bonus_item");
			...
			createjs.Sound.registerSound("./sounds/choose_bonus_item.mp3", "choose_bonus_item");

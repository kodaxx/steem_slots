function CGame(oData) {
	...
	this._initHitAreaColumn = function () {
		...
		for (var i = 0; i < NUM_REELS; i++) {
			...
			oHitArea.addEventListenerWithParams(ON_MOUSE_UP, this._onHitAreaCol, this, {
				index: i
			});
	...
	this.onSpin = function () {
		//TODO add total money detection on spin
